...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x18.pb.CategoryListResponse\"\x00(\x01\x12G\n" +
	"\x16CreateCategoryStreamBi\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00(\x010\x01\x127\n" +
	"\x0eListCategories\x12\t.pb.Blank\x1a\x18.pb.CategoryListResponse\"\x00\x123\n" +
	"\x14ListCategoriesStream\x12\t.pb.Blank\x1a\f.pb.Category\"\x000\x01\x12=\n" +
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	1, // 4: pb.CategoryService.CreateCategoryStreamBi:input_type -> pb.CreateCategoryRequest
	4, // 5: pb.CategoryService.ListCategories:input_type -> pb.Blank
	4, // 6: pb.CategoryService.ListCategoriesStream:input_type -> pb.Blank
	5, // 7: pb.CategoryService.GetCategory:input_type -> pb.GetCategoryRequest
	2, // 8: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	3, // 9: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoryListResponse
	0, // 10: pb.CategoryService.CreateCategoryStreamBi:output_type -> pb.Category
	3, // 11: pb.CategoryService.ListCategories:output_type -> pb.CategoryListResponse
